                    ...
                    <div className=" grid grid-flow-row grid-cols-2">
                      {props.apiSelected.data.response.map((result: any) => (
                        <div className="relative">
                          <div
                            key={result.id}
                            className="m-4 p-4 w-[20rem] h-[15rem] bg-slate-200/90 rounded text-black border-4 outline-1 hover:shadow-[1px_1px_7px_5px_#718096,-3px_3px_40px_5px_#7f9cf5] hover:shadow-slate-400 hover:transition"
                          >
                  ...
                  <>
                    ...
                    {selectedLeagueId && (
                      <div className=" grid grid-flow-row grid-cols-2 ">
                          ...
                          footballApiSelected.data.response.map(
                            (result: any) => (
                              <div>
                                <div
                                  key={result.id}
                                  className="m-4 p-4 w-[20rem] bg-slate-200/90 rounded text-black border-4 outline-1 hover:shadow-[1px_1px_7px_5px_#718096,-3px_3px_40px_5px_#7f9cf5] hover:shadow-slate-400 hover:transition"
                                >
                                  <div className="flex justify-between items-center">
                                    <div className="text-center">
                                      <h2 className="font-bold">HOME</h2>
                        ...
                        // fix this --------
                        {console.log(footballApiSelected.data.response)}
                        {footballApiSelected.data.response == "" && (
                          <p className="text-white flex justify-center items-center">
                            NO GAMES ON TODAY!
                          </p>
                        )}
